...
## Usage:
`yakpro-po`  
Obfuscates according config filename (see config file loading algorythm)
...
`yakpro --clean`  
Requires target_directory present  in config file!
Removes recursivly  target_directory/yakpro-po
